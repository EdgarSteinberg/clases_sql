...
INSERT INTO `donacion` VALUES (1,1,2,3,500.00,'Donaci├│n de ropa de invierno','2024-12-05 10:36:43','2024-06-30'),(2,2,1,1,1000.00,'Alimentos no perecederos','2024-12-05 10:36:43','2024-05-15'),(3,3,4,2,300.00,'Art├¡culos de higiene personal','2024-12-05 10:36:43','2024-07-01'),(4,4,3,4,750.00,'├Ütiles escolares para primaria','2024-12-05 10:36:43','2024-08-15'),(5,5,5,5,250.00,'Juguetes educativos','2024-12-05 10:36:43','2024-06-15'),(6,1,1,2,800.00,'Alimentos para comedor comunitario','2024-12-05 10:36:43','2024-05-30'),(7,2,3,3,450.00,'Material escolar','2024-12-05 10:36:43','2024-07-15'),(8,3,2,1,600.00,'Ropa para ni├▒os','2024-12-05 10:36:43','2024-06-01'),(9,4,5,5,350.00,'Juguetes para navidad','2024-12-05 10:36:43','2024-12-24'),(10,5,4,4,900.00,'Kit de higiene familiar','2024-12-05 10:36:43','2024-08-01');
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_donadores_segun_fecha`(IN periodo DATE )
BEGIN
...
-- Dump completed on 2024-12-05 12:02:55
